...
Starting with warmup, strength exercises, possesion game, theory session, then cutting drill.
...
Therefore, the handler should have the following priorities:
1. First, get the disc into the green zone (center of the field), then
...
4. If not reveived, the cutter now becomes the new front of stack.
